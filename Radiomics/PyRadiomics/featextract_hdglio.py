...
LOG = os.path.join(ROOT, 'log_hdglio.txt')  # Location of output log file
INPUTCSV = os.path.join(ROOT, "hdglio_pyradinp.csv")
OUTPUTCSV = os.path.join(ROOT, "hdglio_pyradout.csv")

# Parallel processing variables
TEMP_DIR = '_TEMP_hdglio'
