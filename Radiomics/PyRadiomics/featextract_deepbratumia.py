...
LOG = os.path.join(ROOT, 'log_deepbratumia.txt')  # Location of output log file
INPUTCSV = os.path.join(ROOT, "deepbratumia_pyradinp.csv")
OUTPUTCSV = os.path.join(ROOT, "deepbratumia_pyradout.csv")

# Parallel processing variables
TEMP_DIR = '_TEMP_deepbratumia'
...
def run(case):
    ...
    try:
        ...
        ptLogger.info('Patient_Timepoint %s read by %s processed in %s', case['Patient_Timepoint'], case['Reader'], delta_t)
