...
filelist = ["ct1_skull_strip.nii.gz", "t1_skull_strip.nii.gz",
            "t2_skull_strip.nii.gz", "flair_skull_strip.nii.gz"]
filenames = ["T1c", "T1", "T2", "FLAIR"]
segname = "seg_mask.nii.gz"
...
for patient in tqdm(patientlist):
    ...
    for tp in tplist:
        ...
        currsegpath = os.path.join(tpdir, 'atlas', 'segmentation', segname)
        ...
        for idx, f in enumerate(filelist):
            ...
            primaryname = "collage_deepbratumia_" + filenames[idx] + "_primary.nii.gz"
            secondaryname = "collage_deepbratumia_" + filenames[idx] + "_secondary.nii.gz"
